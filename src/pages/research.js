...
const ResearchPage = () =>{
    ...
    {
        return (
            <div id={id} class="flex flex-wrap -mx-1 overflow-hidden sm:-mx-1 md:-mx-2 lg:-mx-2 xl:-mx-2">
            <h3 className="bg-yellow-400 w-full text-black text-xl font-bold inline-block p-4">{sectionName}</h3>
                {nodes.map((node,index) => {
                return (
                    <div className="my-1 px-1 w-full overflow-hidden sm:my-1 sm:px-1 sm:w-full md:my-2 md:px-2 md:w-1/2 lg:my-2 lg:px-2 lg:w-1/2 xl:my-2 xl:px-2 xl:w-1/2">
                        <div className = "flex flex-wrap -mx-1 overflow-hidden sm:-mx-1 md:-mx-2 lg:-mx-2 xl:-mx-2">
                            ...
                            <div class="m-auto"> <a href={node.frontmatter.path} className="font-medium no-underline hover:underline text-black text-normal">{node.frontmatter.title}</a> </div>
                            </div>
                        </div>
